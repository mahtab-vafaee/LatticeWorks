...
* [export_fig](https://github.com/altmany/export_fig), to facilitate the creation of publication quality figures. 
...
Please also cite Zenodo DOI [![Zenodo](https://img.shields.io/badge/Zenodo-10.5281/zenodo.13862475-blue.svg)](https://doi.org/10.5281/zenodo.13862475) as a software citation.
...
* Create infill lattice structures within a closed surface, using different lattice types. `DEMO_0012_infill_STL_Lattice` is an example of this application on a vertebrae model.
